...
const PastEvents = (props: PastEventsPropsInterface) => {
    return (
        <div className="bg-[#FFF8FC] p-4 rounded-2xl">
            <div>
            ...
            <div className="event-body">
                <ul className="flex gap-4 mb-3">
                    <li className="text-[#5D5D6C] text-sm">30 Sep 2022</li>
                    <li className="text-[#5D5D6C] text-sm">|</li>
                    <li className="text-[#5D5D6C] text-sm">10:00 AM</li>
                </ul>
